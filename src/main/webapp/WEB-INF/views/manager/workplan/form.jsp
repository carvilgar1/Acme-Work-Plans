...
<jstl:if test="${command!='create' && canUpdate}">
	...
	<acme:form-double readonly="true" code="manager.workplan.form.label.workLoad.entera" path="workLoad.entera"/>
	<acme:form-double readonly="true" code="manager.workplan.form.label.workLoad.decimal" path="workLoad.decimal"/>
