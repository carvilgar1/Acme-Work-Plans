...
public class ManagerMyTasksUpdateTest extends AcmeWorkPlansTest {
	...
	public void updatePositive(final int recordIndex, final String title, final String startDate, 
		...
		super.fillInputBoxIn("workFlow.entera", entera);
		super.fillInputBoxIn("workFlow.decimal", decimal);
	...
	@Order(20)
	public void updatePositive(final int recordIndex, final String title, final String startDate, 
		final String endDate, final String entera, final String decimal, final String publicTask, final String url) {
		super.signIn("manager2", "manager2");
